...
/**
 * {@link Macro} implementation which simulates not resolving the value
 * 
 * @author Dan Vernon
 */
public class NotSuppliedMacro implements Macro {

    private static final Log LOG = Log.getLog(NotSuppliedMacro.class);
