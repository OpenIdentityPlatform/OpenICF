...
import org.identityconnectors.contract.data.macro.DoubleMacro;
import org.identityconnectors.contract.data.macro.Expression;
import org.identityconnectors.contract.data.macro.FloatMacro;
import org.identityconnectors.contract.data.macro.GetMacro;
import org.identityconnectors.contract.data.macro.IntegerMacro;
...
public class DefaultDataProvider implements DataProvider {
    ...
    public DefaultDataProvider() {
        ...
        addMacro(new IntegerMacro());
        addMacro(new LiteralMacro());
        addMacro(new FloatMacro());
        addMacro(new ByteArrayMacro());
        addMacro(new DoubleMacro());
