 ...
 * </p>
 * <p>
 * More detailed information was on the web at
 * {@code https://identityconnectors.dev.java.net/contract-tests-groovy/index.html}
 * (the java.net project site has since been retired).
 * </p>
 *
...
public abstract class Lazy {
     ...
     * </p>
     *
     * @param s the literal string segment to append to this value once it is resolved
     * @return this same {@code Lazy} instance, with {@code s} added to its list of successors
     */
     ...
     *
     * @param pattern the pattern used to generate the random string, as accepted by
     *            {@link org.identityconnectors.contract.data.RandomGenerator#generate(String)}
     * @param clazz the type whose single-{@code String}-argument constructor is invoked
     *            with the generated string to build the returned value
     * @return a {@code Lazy} instance that generates the random value of type {@code clazz}
     *         lazily, when it is resolved
     */
