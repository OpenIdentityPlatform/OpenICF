...
public class RemoteOperationContext
    ...
    protected RemoteOperationContext(final Principal connectionPrincipal, final WebSocketConnectionGroup connectionGroup) {
        this.connectionPrincipal = connectionPrincipal;
        this.connectionGroup = connectionGroup;
    }

    public WebSocketConnectionGroup getRemoteConnectionGroup() {
