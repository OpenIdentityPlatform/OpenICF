...
public class OsgiConnectorFramework extends ConnectorFramework {

    private final AsyncConnectorInfoManager connectorInfoManagerDelegate;

    public OsgiConnectorFramework(final ClassLoader connectorBundleParentClassLoader,
            final AsyncOsgiConnectorInfoManagerImpl connectorInfoManager) {
        super(connectorBundleParentClassLoader);
