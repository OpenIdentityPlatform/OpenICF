...
public class GetAsyncApiOpImpl extends AbstractAPIOperation implements GetAsyncApiOp {
    ...
    public Promise<ConnectorObject, RuntimeException> getObjectAsync(final ObjectClass objectClass,
        ...
        return submitRequest(new InternalRequestFactory(getConnectorKey(), getFacadeKeyFunction(),
                OperationMessages.OperationRequest.newBuilder().setGetOpRequest(requestBuilder)));
    }
    ...
    private static class InternalRequestFactory extends
        ...
        public InternalRequest createRemoteRequest(
                ...
                final CompletionCallback<ConnectorObject, RuntimeException, WebSocketConnectionGroup, WebSocketConnectionHolder, RemoteOperationContext> completionCallback) {
    ...
    private static class InternalRequest
        ...
        public InternalRequest(
                final RemoteOperationContext context,
                final long requestId,
                final RemoteRequestFactory.CompletionCallback<ConnectorObject, RuntimeException, WebSocketConnectionGroup, WebSocketConnectionHolder, RemoteOperationContext> completionCallback,
    ...
    public static AbstractLocalOperationProcessor<ConnectorObject, OperationMessages.GetOpRequest> createProcessor(
