...
/**
 * Asynchronous variant of {@link UpdateApiOp}, exposing the update
 * operations (replace, add attribute values, and remove attribute values)
 * as {@link Promise}s instead of blocking calls.
 *
 * @since 1.5
 */
