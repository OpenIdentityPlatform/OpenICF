...
public interface SchemaOp extends SPIOperation {
     ...
     * dynamic.
     * <p>
     * The special {@link Uid} attribute should never appear in the schema, as it is not a
     * true attribute of an object, only a reference to it. If your resource does have a writable
     * unique id attribute that is different than its {@link Name}, you should create a resource-specific attribute
     * to map to that, such as <I>unix_uid</I>.
