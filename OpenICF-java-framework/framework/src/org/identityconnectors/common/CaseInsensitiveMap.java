...
/**
 * Simple map that uses strings for the key but this case in set to upper case
 * before insertion, access, and removal.
 */
...
public class CaseInsensitiveMap<T> extends HashMap<String, T> {
     ...
     * 
     * @throws NullPointerException
     *             iff key is null in any of the map entries.
     */
    @Override
