...
set CP="%CONNECTOR_SERVER_HOME%\lib\framework\connector-framework.jar";"%CONNECTOR_SERVER_HOME%\lib\framework\connector-framework-internal.jar";"%CONNECTOR_SERVER_HOME%\lib\framework\groovy-all.jar";
...
shift
set SERVICE_NAME=ConnectorServerJava
if not ""%1"" == """" (
    set T=%1
