...
@Test
public class AsyncReversePlainConnectorInfoManagerTest extends AsyncRemotePlainConnectorInfoManagerTest {

    protected ConnectorFrameworkFactory getConnectorFrameworkFactory() throws Exception {
        return serverConnectorFrameworkFactory;
    }

    protected DelegatingAsyncConnectorInfoManager getConnectorInfoManager() throws Exception {
        return getConnectorFramework().getServerManager("anonymous");
    }
