 ...
 * @since 1.0.0
 */
public class OsgiConnectorFacadeImpl extends AbstractConnectorFacade {
     ...
     */
    public OsgiConnectorFacadeImpl(final Bundle bundle,
            final APIConfigurationImpl apiConfiguration) {
        super(apiConfiguration);
        this.connectorInfo = (LocalConnectorInfoImpl) apiConfiguration.getConnectorInfo();
    }
