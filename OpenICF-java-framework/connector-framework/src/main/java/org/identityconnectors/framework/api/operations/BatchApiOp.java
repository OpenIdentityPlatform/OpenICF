...
/**
 * Execute a series of {@link org.identityconnectors.framework.api.operations.APIOperation}.
 *
 * If a resource does not support batch operations in any form and it cannot be coerced into doing so then the
 * connector will not implement the {@link org.identityconnectors.framework.spi.operations.BatchOp} interface.
