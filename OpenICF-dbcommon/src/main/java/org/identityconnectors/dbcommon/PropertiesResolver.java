...
public final class PropertiesResolver {
    ...
    public static Properties resolveProperties(Properties properties, Properties resolvedProperties) {
        ...
        return resolveProperties(copyProperties(properties), copyProperties(resolvedProperties),
    ...
    private static Properties resolveProperties(Properties properties,
            Properties resolvedProperties, Set<String> justResolving) {
        for (Map.Entry<Object, Object> entry : properties.entrySet()) {
            String value = (String) entry.getValue();
            if (value.contains("$")) {
                value =
                        resolveName((String) entry.getKey(), properties, resolvedProperties,
                                justResolving);
    ...
    private static String resolveName(String name, Properties properties,
            Properties resolvedProperties, Set<String> justResolving) {
        String value = null;
        ...
        while (index >= 0 && index < length) {
            ...
            if (varStart >= 0) {
                ...
                if (varEnd >= 0) {
                    ...
                    String varValue =
                            resolveName(varName, properties, resolvedProperties, justResolving);
