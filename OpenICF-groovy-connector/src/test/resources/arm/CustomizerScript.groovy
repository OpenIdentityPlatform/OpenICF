...
customize {
    ...
    decorate { HttpClient httpClient ->
        ...
        RESTClient restClient = new InnerRESTClient(c.serviceAddress, c.defaultContentType, authCache)
...
class InnerRESTClient extends RESTClient {
    ...
    InnerRESTClient(Object defaultURI, Object defaultContentType, authCache) throws URISyntaxException {
