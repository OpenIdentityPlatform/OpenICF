...
class ScriptedPoolableConnector extends ScriptedConnectorBase<ScriptedConfiguration> implements PoolableConnector {
    ...
    @Override
    protected Binding createBinding(Binding arguments, ScriptedConnectorBase.Action action, ObjectClass objectClass, Uid uid, Set<Attribute> attributes, OperationOptions options) {
        Binding binding = createBinding(arguments, action, objectClass, uid, attributes, options)
